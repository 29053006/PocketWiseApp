...
class LanguageProvider with ChangeNotifier {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      // Categories
      'food': 'Food', 'transport': 'Transport', 'home': 'Home', 'shopping': 'Shopping',
      'health': 'Health', 'movies': 'Movies', 'salary': 'Salary', 'bonus': 'Bonus',
      'investment': 'Investment', 'gift': 'Gift', 'other': 'Other', 'dining': 'Dining',
      'netflix': 'Netflix', 'groceries': 'Groceries',
    },
    'es': {
      'home': 'Inicio',
      'history': 'Historial',
      ...
      // Categories
      'food': 'Comida', 'transport': 'Transporte', 'home': 'Hogar', 'shopping': 'Compras',
      'health': 'Salud', 'movies': 'Cine', 'salary': 'Salario', 'bonus': 'Bono',
      'investment': 'Inversión', 'gift': 'Regalo', 'other': 'Otro', 'dining': 'Cenas',
      'netflix': 'Netflix', 'groceries': 'Supermercado',
    },
  };
